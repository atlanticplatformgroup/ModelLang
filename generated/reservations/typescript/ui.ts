...
import type { Reservation, ReserveInput, ReservationsForResourceInput } from "./types.js";
    ...
    async execute<Id extends ReservationsUiOperationId>(
      ...
      switch (operationId) {
        case "action:act_508ad810a19d4b79a5009871de5cd26b":
          return await client.reserve(input as unknown as ReserveInput) as ReservationsUiResultByOperationId[Id];
