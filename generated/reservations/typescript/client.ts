...
import type { User, Resource, Reservation, ResourceSummary, ReservationSummary, ReserveInput, ReservationsForResourceInput, ApplicabilityDecision, ApplicabilityOptions, ExecutionOptions } from "./types.js";
...
export class ReservationsClient {
  ...
  async reservationsForResource(input: ReservationsForResourceInput): Promise<ReservationSummary[]> {
    try {
      const result = await this.adapter.query<{ value: ReservationSummary[] }>(
