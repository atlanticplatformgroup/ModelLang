...
BEGIN
  ...
  IF p_cursor IS NOT NULL THEN
    ...
    IF v_cursor_json ->> 'modelId' IS DISTINCT FROM 'model:Reservations'
      OR v_cursor_json ->> 'modelVersion' IS DISTINCT FROM '0.46.0'
      OR v_cursor_json ->> 'sourceHash' IS DISTINCT FROM 'sha256:c689a78580be5be667408b717f2605c40b65af4a0af0923d77830e9f3a53ee69'
