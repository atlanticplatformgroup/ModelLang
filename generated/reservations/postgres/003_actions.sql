...
BEGIN
  ...
  VALUES ('model:Reservations', '0.46.0', 'sha256:c689a78580be5be667408b717f2605c40b65af4a0af0923d77830e9f3a53ee69', 'action:act_508ad810a19d4b79a5009871de5cd26b', v_principal_id, v_idempotency_key, v_request_hash, v_correlation_id, v_causation_id)
  ...
  IF v_receipt_id IS NULL THEN
    ...
    IF v_receipt_source_hash IS DISTINCT FROM 'sha256:c689a78580be5be667408b717f2605c40b65af4a0af0923d77830e9f3a53ee69' OR v_receipt_request_hash IS DISTINCT FROM v_request_hash THEN
...
;
  ...
  VALUES ('model:Reservations', '0.46.0', 'sha256:c689a78580be5be667408b717f2605c40b65af4a0af0923d77830e9f3a53ee69', 'event:evt_40d694c9a0a274dc79c6168e47d25968', 'ReservationCreated', 'entity:ent_ba2d028e915841d1ab90adfa40d38404', 'action:act_508ad810a19d4b79a5009871de5cd26b', v_principal_id, v_result."id", v_response, v_correlation_id, v_causation_id, v_action_audit_id, v_receipt_id, 0, 5, 'manual');
