...
BEGIN
  ...
  VALUES ('model:Reservations', '0.49.0', 'sha256:9f79a678a282076919e01cfdb1bd90759e4383aa53c1ac72343c40812cb66ef4', 'action:act_508ad810a19d4b79a5009871de5cd26b', v_principal_id, v_idempotency_key, v_request_hash, v_correlation_id, v_causation_id)
  ...
  IF v_receipt_id IS NULL THEN
    ...
    IF v_receipt_source_hash IS DISTINCT FROM 'sha256:9f79a678a282076919e01cfdb1bd90759e4383aa53c1ac72343c40812cb66ef4' OR v_receipt_request_hash IS DISTINCT FROM v_request_hash THEN
