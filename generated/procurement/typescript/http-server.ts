...
function validateDelegatedClaim(
  ...
  const valid = Object.keys(claim).every((key) => allowed.has(key))
    ...
    && model?.sourceHash === "sha256:376adbaa8d064194ffa8c604fcb274d288bfe3e75aa0a8693437668f78dd1c54"
...
export async function invokeProcurementExtension(
  ...
  return {
    ...
    catalogVersion: 7,
    model: {"id":"model:Procurement","name":"Procurement","version":"0.48.0","sourceHash":"sha256:376adbaa8d064194ffa8c604fcb274d288bfe3e75aa0a8693437668f78dd1c54"},
