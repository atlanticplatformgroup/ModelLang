...
import type { OpenRequestInput, SubmitRequestInput, ApproveRequestInput, MyRequestsInput } from "./types.js";
...
export interface ProcurementOperationExecutor {
  execute(operationId: ProcurementOperationId, input: Readonly<Record<string, unknown>>): Promise<unknown>;
}
...
export function createProcurementDatabaseExecutor(
  ...
  return {
    async execute(operationId, input) {
      switch (operationId) {
      case "action:act_1e35db0451b1461e941af6283d86dca2": return client.openRequest(input as unknown as OpenRequestInput);
      case "action:act_ed2374e822704c51a2925338253d05d2": return client.submitRequest(input as unknown as SubmitRequestInput);
      case "action:act_d39dbb883b5f4019b9027b85add3de47": return client.approveRequest(input as unknown as ApproveRequestInput);
