...
BEGIN
  ...
  VALUES ('model:Procurement', '0.28.0', 'sha256:b84dcde53f682175f8bdf448d921c82f9e25ddcafea82bdbc36914c54bf92033', 'action:act_1e35db0451b1461e941af6283d86dca2', v_principal_id, v_idempotency_key, v_request_hash, v_correlation_id, v_causation_id)
  ...
  IF v_receipt_id IS NULL THEN
    ...
    IF v_receipt_source_hash IS DISTINCT FROM 'sha256:b84dcde53f682175f8bdf448d921c82f9e25ddcafea82bdbc36914c54bf92033' OR v_receipt_request_hash IS DISTINCT FROM v_request_hash THEN
...
BEGIN
  ...
  IF p_envelope->>'eventId' IS DISTINCT FROM 'event:evt_30d694c9a0a274dc79c6168e47d25968'
     ...
     OR v_source_model_version IS DISTINCT FROM '0.28.0'
     OR v_source_hash IS DISTINCT FROM 'sha256:b84dcde53f682175f8bdf448d921c82f9e25ddcafea82bdbc36914c54bf92033'
