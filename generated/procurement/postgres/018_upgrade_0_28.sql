...
BEGIN
  ...
  IF NOT FOUND
     ...
     OR v_source_hash IS DISTINCT FROM 'sha256:f88b6d6270a9e5d6cb6a4b49979477d8e58cc060d0b423099f1dc1695653960f' THEN
    RAISE EXCEPTION USING ERRCODE = '55000', MESSAGE = 'ML_MIGRATION_BASELINE:sha256:f88b6d6270a9e5d6cb6a4b49979477d8e58cc060d0b423099f1dc1695653960f';
  END IF;
END
$modellang_upgrade$;
