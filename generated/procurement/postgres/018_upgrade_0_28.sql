...
BEGIN
  ...
  IF NOT FOUND
     ...
     OR v_version IS DISTINCT FROM '0.28.0'
     OR v_source_hash IS DISTINCT FROM 'sha256:b84dcde53f682175f8bdf448d921c82f9e25ddcafea82bdbc36914c54bf92033' THEN
    RAISE EXCEPTION USING ERRCODE = '55000', MESSAGE = 'ML_MIGRATION_BASELINE:sha256:b84dcde53f682175f8bdf448d921c82f9e25ddcafea82bdbc36914c54bf92033';
  END IF;
END
$modellang_upgrade$;
