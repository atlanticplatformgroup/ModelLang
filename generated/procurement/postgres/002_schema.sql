-- source sha256:84969af54e131f4e9751a5798913868b43f2b70f3345402a4ad03a9b5d781c90
...
BEGIN
  ...
  WITH candidates AS (
    SELECT row_value."terminal_at" AS terminal_at, row_value."consumer_id" AS consumer_id,
      ...
      row_value."consumer_id" IN ('consumer:con_10d694c9a0a274dc79c6168e47d25968') AS recovery_eligible
...
VALUES ('model:Procurement', '0.27.0', 'sha256:84969af54e131f4e9751a5798913868b43f2b70f3345402a4ad03a9b5d781c90', 'installation');
RESET ROLE;
