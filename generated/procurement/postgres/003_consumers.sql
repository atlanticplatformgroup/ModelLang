...
BEGIN
  ...
  IF p_envelope->>'eventId' IS DISTINCT FROM 'event:evt_30d694c9a0a274dc79c6168e47d25968'
     ...
     OR v_source_model_version IS DISTINCT FROM '0.39.0'
     OR v_source_hash IS DISTINCT FROM 'sha256:89e89237e4c93adaca962b74285b1277892bd4abd2f7f51e50ad90248006e8aa'
  ...
  VALUES ('model:Procurement', '0.39.0', 'sha256:89e89237e4c93adaca962b74285b1277892bd4abd2f7f51e50ad90248006e8aa', 'event:evt_50d694c9a0a274dc79c6168e47d25968', 'ApprovalObserved', 'entity:ent_9bc680209327484c8e98f5f740bcc702', 'consumer:con_10d694c9a0a274dc79c6168e47d25968', v_result."id", v_response, v_correlation_id, v_source_event_id::text, v_consumer_audit_id, 0, 5, 'manual');
