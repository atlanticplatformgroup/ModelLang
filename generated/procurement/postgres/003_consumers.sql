...
BEGIN
  ...
  IF p_envelope->>'eventId' IS DISTINCT FROM 'event:evt_30d694c9a0a274dc79c6168e47d25968'
     ...
     OR v_source_model_version IS DISTINCT FROM '0.47.0'
     OR v_source_hash IS DISTINCT FROM 'sha256:3a8297616e7a73b4f126ca2802e087ab034e2dff549e5f4913fc754c3634938e'
  ...
  VALUES ('model:Procurement', '0.47.0', 'sha256:3a8297616e7a73b4f126ca2802e087ab034e2dff549e5f4913fc754c3634938e', 'event:evt_50d694c9a0a274dc79c6168e47d25968', 'ApprovalObserved', 'entity:ent_9bc680209327484c8e98f5f740bcc702', 'consumer:con_10d694c9a0a274dc79c6168e47d25968', v_result."id", v_response, v_correlation_id, v_source_event_id::text, v_consumer_audit_id, 0, 5, 'manual');
