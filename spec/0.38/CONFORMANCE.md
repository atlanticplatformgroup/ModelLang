...
11. emits compiler 0.38.0, canonical IR1, agent catalog v1, target profile v2, target `target:postgresql-http-ui-agent-catalog/2`, generator profile `/22`, and one complete current PostgreSQL installation baseline with no historical operational upgrades or runtime-profile ledger;
